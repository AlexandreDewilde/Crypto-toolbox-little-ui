...
function encryptMessage() {
    ...
    document.getElementById("encrypted-text").value = encrypt.encrypt(document.getElementById('unencrypted-text').value);
}

function decryptMessage() {
    encrypt.setPrivateKey(document.getElementById('rsa-private-key').value);
    document.getElementById("unencrypted-text").value = encrypt.decrypt(document.getElementById('encrypted-text').value); 
}
